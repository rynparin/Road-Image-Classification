...
output_path = "/Users/yaninchaya/Desktop/DataSci/FinalProject/images/justPoor"
search_terms = [
    'ถนนซ่อมยางมะตอย'
...
PATH = '/Users/yaninchaya/opt/miniconda3/bin/chromedriver'
...
def fetch_image_urls(
    ...
    while image_count < max_links_to_fetch:
        ...
        for img in thumbnail_results[results_start:number_results]:
            ...
            # Extract image urls
            actual_images = wd.find_elements(By.CLASS_NAME, "rg_i.Q4LuWd")
            ...
            try:
                not_what_you_want_button = wd.find_elements(By.CLASS_NAME, ".r0zKGf")
            except:
                pass
            ...
            load_more_button = wd.find_elements(By.XPATH, "//div[@ng-click='ctrl.loadMoreFeedItems()']")
...
def persist_image(folder_path: str, url: str):
    ...
    try:
        ...
        with open(file_path, "wb") as f:
            ...
            resized_image.save(f, "JPEG", quality=IMAGE_QUALITY)
